...
const CurriculumManagement: React.FC<CurriculumManagementProps> = ({
  ...
  const filteredCurriculums = curriculums.filter((curriculum) => {
    const matchesSearch =
      ...
      curriculum.code?.toLowerCase().includes(filter.search.toLowerCase());
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Enter curriculum code (e.g., CBC, IGCSE)"
              />
            </div>
            <div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="edit-code">Curriculum Code</Label>
              <Input
                id="edit-code"
                value={formData.code}
                onChange={(e) =>
